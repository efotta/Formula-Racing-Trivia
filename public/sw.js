...
// Version bumped to v14 - V9 FIX: Extra 500ms delay after audio completes on iPhone
const CACHE_NAME = 'formula-racing-trivia-v14';
const urlsToCache = [
  '/',
  '/manifest.json',
  '/icon-192x192.png',
...
self.addEventListener('activate', (event) => {
  ...
  event.waitUntil(
    caches.keys()
      ...
      .then(() => {
        console.log('[SW] Service Worker v14 activated! 🚀');
